...
'',
	...
	'toggle-collapse.png': /*
		...
		--SEPARATOR
		Content-Type:image/png
		Content-Location:toggle-collapse.png
		Content-Transfer-Encoding:base64
		*/
...
'',
	...
	'closeicon.png': /*
		...
		--SEPARATOR
		Content-Type:image/png
		Content-Location:closeicon.png
		Content-Transfer-Encoding:base64
		*/
...
Mif.sheet.addRules({
	...
	'.mif-tree-toggle-minus': {
		'background-image': 'toggle-collapse.png'.toMifImg()
	},

	'.mif-tree-toggle-plus': {
		'background-image': 'toggle-expand.png'.toMifImg()
	},
	
	'.mif-tree-node-selected .mif-tree-toggle-minus': {
		'background-image': 'toggle-collapse-selected.png'.toMifImg()
	},
	
	'.mif-tree-node-selected .mif-tree-toggle-plus': {
		'background-image': 'toggle-expand-selected.png'.toMifImg()
	},	
...
Mif.Tree.Node = new Class({
	...
	initialize: function(structure, options) {
		...
		this.property = $extend($unlink(this.tree.dfltState), options.property);
		this.$calculate();
	...
	toggle: function(state) {
		...
		if(this.loadable && !this.property.loaded) {
            if(!this.load_event){
...
Mif.Tree.Draw = {
	...
	getHTML: function(node,html){
		...
		'<div class="mif-tree-node ',(node.isLast() ? 'mif-tree-node-last' : ''),'"'+(node.hidden ? ' style="display:none"' : '')+' id="',prefix,node.UID,'">',
			'<span class="mif-tree-node-wrapper ',node.cls,(node.property.selected ? ' mif-tree-node-selected' : ''),'" uid="',node.UID,'">',
				'<span class="mif-tree-toggle mif-tree-toggle-',node.getToggleType(),'" uid="',node.UID,'">',Mif.Tree.Draw.zeroSpace,'</span>',
				checkbox,
